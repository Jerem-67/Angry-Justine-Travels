    ...
    <form method="GET" action="#">
        ...
        <fieldset>
            ...
            <div class="reponse">
                ...
                if (!empty($_GET["rep2"])) {
                    $tentative += 1;
                    echo "<p>BRAVO ! Angry Justine a trouvé son gâteau préféré <3 </p>";
                    echo "<div class=\"rep-img\"><img class=\"icon\" src='image/food.png'><a class='next' href='enigme6.php'>Next !</a></div>";
