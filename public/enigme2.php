        ...
        <fieldset>
            ...
            <div class="container">
                ...
                <div class="rep">
                    <div class="interieur">
                        <div>
                            <input type="submit" value="Berlin" class="btn" name="rep1">
                        </div>
                        <div>
                            <input type="submit" value="Dacca" class="btn" name="rep2">
                        </div>
                    </div>
                    <div class="interieur">
                        <div>
                            <input type="submit" value="Rome" class="btn" name="rep3">
                        </div>
                        <div>
                            <input type="submit" value="Lisbonne" class="btn" name="rep4">
                        </div>
                    </div>
                </div>
                <div class="reponse">
